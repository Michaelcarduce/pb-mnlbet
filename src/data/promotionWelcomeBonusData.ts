export interface PromotionWelcomeBonusItem {
  id: number;
  imageUrl: string;
  title: string;
  link: string;
...
export const promotionWelcomeBonusItems: PromotionWelcomeBonusItem[] = [
  {
    id: 1,
    imageUrl: "/banners/banner1.webp",
    title: "First Slide Title",
    alt: "First Slide Title",
    link: "/",
  },
  {
    id: 2,
