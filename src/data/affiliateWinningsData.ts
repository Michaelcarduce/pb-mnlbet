export const affiliateWinningsData = [
  {
    id: 1,
    ...
    subList: [
      {
        id: "sub11",
        description: `This method lets you directly send your money to your bank account. This is a safe option even if the processing time could be greater than with e-values or cryptocurrency.`,
      },
      {
        id: "sub12",
        description: `PayMaya, GCash, PayPal, and other fast, safe, and simple e-wallet apps let you practically immediately withdraw your money to your mobile wallet.`,
      },
      {
        id: "sub13",
        description: `Should you make your investment in cryptocurrency, you also have choices for withdrawing your profits. Processing cryptocurrencies quickly and with significant degree of anonymity, they are`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subList: [
      {
        id: "sub11",
        description: `Sometimes bank transfers take several business days to complete.`,
      },
      {
        id: "sub12",
        description: `Usually, e-walays are handled in 24 hours.`,
      },
      {
        id: "sub13",
        description: `Usually handling a Bitcoin withdrawal takes minutes.`,
      },
    ],
  },
  {
