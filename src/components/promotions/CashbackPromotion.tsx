...
import { promotionCashbackItems } from "@/data/promotionCashbackData";

interface CashbackPromotionProps {
  title: string;
...
export const CashbackPromotion = ({
  title,
  description,
  className = "",
  titleClassName = "",
    ...
    <section className={cn("p-8 lg:p-12 ", className)}>
      ...
      <div className="flex items-center justify-center flex-col lg:flex-row ">
        <div className="flex w-full lg:w-[80%] items-center justify-center ">
          <FeaturedPromotionBanner items={promotionCashbackItems} />
        </div>
      </div>
      <div
        className={cn(
