...
interface PromotionCardGridProps {
  items: CardGridItem[];
  className?: string;
...
// export default function PromotionCardGrid({
//   items,
//   className = "",
//   cardClassName = "",
//   imageClassName = "",
...
//           <div
//             key={`skeleton-${i}`}
//             className="w-[500px] h-[160px] bg-gray-200 rounded-xl animate-pulse border-2 border-yellow-500"
//           />
//         ))}
//       </div>
//     );
...
//             <Link
//               href={item.link}
//               className={`block w-[500px] h-[220px] rounded-xl shadow-md overflow-hidden ${cardClassName}`}>
...
//           <div
//             key={`skeleton-${i}`}
//             className="w-[300px] h-[100px] md:w-[500px] md:h-[160px] bg-gray-200 rounded-xl animate-pulse border-2 border-yellow-500"
//           />
//         ))}
//       </div>
//     );
...
//             }}>
//             <div
//               className={`flex flex-col w-[250px] md:w-[500px] rounded-xl shadow-md overflow-hidden ${cardClassName}`}>
//               {/* Responsive Image Container */}
//               <div
//                 className={`relative w-full h-[120px] md:h-[160px] ${imageClassName}`}>
//                 <Image
//                   src={item.imageUrl}
//                   alt={item.alt}
