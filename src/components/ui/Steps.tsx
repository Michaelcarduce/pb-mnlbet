...
export const Steps = ({
  ...
  useEffect(() => {
    ...
    // Add a slight debounce to improve performance
        ...
        <div className="relative w-full p-2 md:p-6">
          <div className="relative flex flex-col w-full">
            ...
            {cards.map((step) => (
              <motion.div
                key={step.id}
                data-step-id={componentId} // Add the unique identifier
                className={cn(
                  "relative flex items-start gap-4 py-4 md:py-8",
                  activeStep === step.id ? "font-[400]" : "text-gray-500",
                  cardClassName,
                  activeStep === step.id && activeCardClassName
                )}
